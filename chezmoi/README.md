...
# 方法 2：先 clone 再執行
git clone https://github.com/weiting-tw/macos-dotfiles-nexus.git
cd macos-dotfiles-nexus/chezmoi
bash install.sh
```
...
# 3. 在新機器執行：
chezmoi init --apply https://github.com/weiting-tw/macos-dotfiles-nexus.git
```
